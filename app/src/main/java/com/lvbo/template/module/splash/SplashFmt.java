 ...
 */
public class SplashFmt extends BaseFragment implements ILogin.view {
    ...
    public static SplashFmt getInstance() {
        SplashFmt splashFmt = new SplashFmt();
        return splashFmt;
    }
...
//                    replaceFragmentWithBackStack(TutorialFmt.getInstance(Constant.SHOW_TOOL_BAR, -1));
                    addFragmentToTop(TutorialFmt.getInstance());
                } else {
                   ...
                   String facebookId= (String) SPUtils.get(getBaseActivity(),Constant.KEY_FACEBOOK_ID,"");
                    ...
                    if (!TextUtils.isEmpty(userName) && !TextUtils.isEmpty(password)) {
                        LoginPresenter presenter=new LoginPresenter(SplashFmt.this);
                        presenter.login();
