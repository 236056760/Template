 ...
 */
public class MapLocatorFmt extends BaseFragment implements OnMapReadyCallback {
    ...
    public static MapLocatorFmt getInstance() {
        MapLocatorFmt splashFragment = new MapLocatorFmt();
